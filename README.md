...
The file `target/a2kImageManipulation-1.0.1.jar` will be created.

### Run it:

```
java -jar target/a2kImageManipulation-1.0.1.jar --in /path/to/images --out /path/to/output --infix "summer" --link 
```	
